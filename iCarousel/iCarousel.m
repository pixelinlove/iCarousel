...
- (void)removeItemAtIndex:(NSInteger)index animated:(BOOL)animated
{
    ...
    if (animated)
    {
        ...
        [UIView animateWithDuration:INSERT_DURATION
                         ...
                         animations:^{
            // Place properties and methods that change within the animation block.
            ...
            // This is called after the animations above complete.
            if (finished) {
                [self depthSortViews];
            }
        }];
...
- (void)insertItemAtIndex:(NSInteger)index animated:(BOOL)animated
{
    ...
    if (animated)
    {
        ...
        [UIView animateWithDuration:INSERT_DURATION
                         animations:^{
            // Perform transformations within this block.
            [self transformItemViews];
        } completion:^(BOOL finished){
            // Completion block to be executed after animations.
            if (finished) {
                [self didScroll];
            }
        }];
